    ...
    create : function(username, password, config, callback){
        phantom.create('--cookies-file=cookie2.txt', function(ph){
            ph.createPage(function(page){
                ...
                callback(new WeiboSina(username, password, page, ph));
            });
        });
    }
};

function WeiboSina(username, password, page, ph) {
    var _self = this;
    var _is_login = false;
    var _open_list = [];
...
WeiboSinaFactory.create('18602283721', '113456', {}, function(weibo){
    console.log('create a weibo client.');
/*
    var http = require('http');
    http.createServer(function (req, res) {
        weibo.open("http://weibo.com/u/2067078335", function(obj, nextPage){
            setTimeout(function(){
